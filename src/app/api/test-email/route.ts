...
// TEMP: Remove after confirming email delivery works
...
<body style="margin:0;padding:0;background:#faf9f6;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:white;padding:32px;border:1px solid #ede8df;border-top:none;">
      <p style="color:#e53e3e;font-size:12px;background:#fff5f5;border:1px solid #fed7d7;border-radius:8px;padding:8px 12px;margin:0 0 20px;">⚠️ TEST EMAIL</p>
      <p style="color:#4a5568;font-size:15px;line-height:1.6;margin:0 0 20px;">Hey there,</p>
      <p style="color:#4a5568;font-size:15px;line-height:1.6;margin:0 0 24px;">
        Your <strong style="color:#1c3557;">Real Estate Agent's AI Prompt Toolkit</strong> is ready to download.
      </p>
    ...
    <div style="padding:20px;text-align:center;">
      <p style="color:#a0aec0;font-size:12px;margin:0;">© 2025 Workshift</p>
    </div>
  </div>
</body>
</html>`;
  ...
  try {
    ...
    return NextResponse.json({ success: true, email, downloadUrl, resend_id: data.id });
  } catch (err: unknown) {
